...
const statusFlows: Record<Direction, Array<{ key: StatusKey; label: string; detail: string }>> = {
  toPartner: [
    ...
    { key: 'enRoutePickup', label: 'Customer → Driver', detail: 'Navigating to pickup location' },
    { key: 'pickedUp', label: 'Picked Up', detail: 'Laundry secured with photo proof' },
    { key: 'atPartner', label: 'Driver → Partner', detail: 'Laundry delivered with photo proof' },
    { key: 'completed', label: 'Completed', detail: 'Job auto-submitted to earnings' },
  ],
  toCustomer: [
    { key: 'accepted', label: 'Accepted', detail: 'Job locked in, prep to move' },
    { key: 'enRoutePickup', label: 'Partner → Driver', detail: 'Heading to collect clean load' },
    ...
    { key: 'returning', label: 'Driver → Customer', detail: 'Navigating to customer drop-off' },
